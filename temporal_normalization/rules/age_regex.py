...
PLEISTOCENE_AGE = CASE_INSENSITIVE + r"(" + TEXT_START + r"(pleistocen)" + TEXT_END + r")"

# <a href="http://dbpedia.org/page/Mesolithic">Mesolithic</a>
MESOLITHIC_AGE = CASE_INSENSITIVE + r"(" + TEXT_START + r"(epipaleolitic)" + TEXT_END + r")"

# <a href="http://dbpedia.org/page/Chalcolithic">Chalcolithic</a>
CHALCOLITHIC_AGE = CASE_INSENSITIVE + r"(" + TEXT_START + r"(eneolitic)" + TEXT_END + r")"
...
AURIGNACIAN_CULTURE = CASE_INSENSITIVE + r"(" + TEXT_START + r"(aurignacian)" + TEXT_END + r")"

# <a href="http://dbpedia.org/page/Hallstatt_culture">Hallstatt Culture</a>
HALLSTATT_CULTURE = CASE_INSENSITIVE + r"(" + TEXT_START + r"(hallstatt)" + TEXT_END + r")"
...
MIDDLE_AGES = (
        ...
        + r"("
        + TEXT_START
        + r"((medieval" + REGEX_OR + r"medievala))"
        + TEXT_END
        + r")"
)

# <a href="http://dbpedia.org/page/Modern_history">Modern History</a>
MODERN_AGES = CASE_INSENSITIVE + r"(" + TEXT_START + r"(moderna)" + TEXT_END + r")"
...
PTOLEMAIC_DYNASTY = (
        ...
        + r"("
        + TEXT_START
        + r"(ptolem" + ANY_WORDS + r")"
        + TEXT_END
        + r")"
)

# <a href="http://dbpedia.org/page/Roman_Empire">Roman Empire</a>
ROMAN_EMPIRE_AGE = CASE_INSENSITIVE + r"(" + TEXT_START + r"(romana)" + TEXT_END + r")"
...
NERVA_ANTONINE_DYNASTY = (
        ...
        + r"("
        + TEXT_START
        + r"((antoninian" + ANY_WORDS + REGEX_OR + r"hadrian))"
        + TEXT_END
        + r")"
)

# <a href="http://dbpedia.org/page/Renaissance">Renaissance</a>
RENAISSANCE = CASE_INSENSITIVE + r"(" + TEXT_START + r"(renastere)" + TEXT_END + r")"
...
FRENCH_CONSULATE_AGE = (
        ...
        + r"("
        + TEXT_START
        + r"(perioada consulatului francez)"
        + TEXT_END
        + r")"
)

# <a href="http://dbpedia.org/page/World_War_I">World War I</a>
WW_I_PERIOD = CASE_INSENSITIVE + r"(" + TEXT_START + r"(primul razboi mondial)" + TEXT_END + r")"

# <a href="http://dbpedia.org/page/Interwar_period">Interwar Period</a>
INTERWAR_PERIOD = CASE_INSENSITIVE + r"(" + TEXT_START + r"(interbelica)" + TEXT_END + r")"
...
WW_II_PERIOD = (
        ...
        + r"("
        + TEXT_START
        + r"((al (doilea" + REGEX_OR + r"ii-lea) razboi mondial))"
        + TEXT_END
        + r")"
)
